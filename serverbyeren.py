...
if __name__ == "__main__":
	...
	muted_list=[]
	buffer = 4096
	port = 5001# güvenlik duvarı vb. ile gelen kuralı olarak engellenmemeli
	...
	try:
			...
			for sock in rList:
				if sock == server_socket: # yeni bir bağlantı
					...
					try:
						...
						if i in banned_list: # banlanmış ama hala burada
							msg=f"\r\33[1m\33[31m banlandın dostum\33[0m\n"
							sock.send(bytes(msg,'utf-8'))
							connected_list.remove(sock)
							sock.close()
						elif data == "exit": # çıkış mesajı
		...
		print("\n\33[32mChat by Eren: sunucu kapatılıyor\33[0m")
		server_socket.close()
